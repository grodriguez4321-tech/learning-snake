...
class LessonContent(QWidget):
    ...
    def __init__(self, theme: Theme, parent: QWidget | None = None) -> None:
        ...
        learn_body = QWidget()
        learn_outer = QVBoxLayout(learn_body)
        learn_outer.setContentsMargins(28, 22, 20, 20)
        learn_outer.setSpacing(0)
        ...
        learn_outer.addWidget(learn_col, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        ex_body = QWidget()
        ex_outer = QVBoxLayout(ex_body)
        ex_outer.setContentsMargins(28, 22, 20, 20)
        ex_outer.setSpacing(0)
        ex_col = QWidget()
        ...
        ex_l.addStretch(1)
        ex_outer.addWidget(ex_col, alignment=Qt.AlignmentFlag.AlignHCenter)
        ...
        pr_body = QWidget()
        pr_outer = QVBoxLayout(pr_body)
        pr_outer.setContentsMargins(28, 22, 20, 20)
        pr_outer.setSpacing(0)
        pr_col = QWidget()
        pr_col.setObjectName("ContentColumn")
        pr_col.setSizePolicy(QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Preferred)
        pr_col.setMaximumWidth(940)
        pr_l = QVBoxLayout(pr_col)
        ...
        pr_l.addStretch(1)
        pr_outer.addWidget(pr_col, alignment=Qt.AlignmentFlag.AlignHCenter)
